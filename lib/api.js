...
export const getCaseDocsWithAgentToken = (id) =>
  agentHttp.get(`${AUTH_PATHS.GET_CASE_DOCS}/${id}`, BASE_HEADERS);
...
export const webGetBusinessImageWithAgentToken = (id) =>
  agentHttp.get(`${AUTH_PATHS.WEB_GET_BUSINESS_IMAGE}/${id}`, BASE_HEADERS);
